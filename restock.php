    ...
    <section class="section">
      <div class="row">
        ...
        <div class="card" id="myForm" style="display: none;">
            <div class="card-body" >
              <h5 class="card-title">Add Grocery Item Form</h5>

              <!-- Floating Labels Form -->
              <form method="get"  action="./controllers/addGroceryItem.php" class="row g-3">
                <div class="col-md-4">
                  <div class="form-floating">
                    <input required type="text" class="form-control" name="item_name" id="floatingName" placeholder="Item Name">
                    <label for="floatingName">Item Name</label>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-floating">
                    <input required type="number" class="form-control" name="quantity" id="floatingEmail" placeholder="Quantity">
                    <label for="floatingEmail">Quantity</label>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-floating">
                    <input required type="number" class="form-control" name="price" id="floatingPassword" placeholder="Price">
                ...
                <div class="col-md-1">
                    ...
                    <div class="form-floating">
                      <input required type="number" min=0 max=1 value=0 class="form-control" name="is_veg" id="floatingCity" placeholder="isVegetarian">
                ...
                <div class="col-md-2">
                  ...
                  <input required type="text" name="type" class="form-control" name="price" id="floatingSelect" placeholder="type">
                ...
                <div class="col-md-9">
                  <div class="form-floating">
                    <input required type="text" name="desc" class="form-control" id="floatingZip" placeholder="Description">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table datatable">
                ...
                <tbody>
                <?php require "./getGroceryItems.php"?>
