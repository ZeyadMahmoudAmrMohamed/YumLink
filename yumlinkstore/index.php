            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-12 col-lg-7">
                        ...
                        <h3 class="mb-5 display-3 text-primary">Yum - Link Grocery Store </h3>
        ...
        <div class="container-fluid banner bg-secondary my-5">
            <div class="container py-5">
                <div class="row g-4 align-items-center">
                    <div class="col-lg-6">
                        <div class="py-4">
                            <h1 class="display-3 text-white" style="font-family:'Poppins', sans-serif;">Fresh Exotic Fruits</h1>
                            <p class="fw-normal display-3 text-dark mb-4">in Our Store</p>
                            <p class="mb-4 text-dark">Apples are yummy fruits that come in lots of colors and flavors. They're good for you, with fiber and vitamins that keep you healthy. People love them in pies, juices, and salads. </p>
